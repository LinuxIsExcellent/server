...
namespace base
{
    namespace dbo
    {
        ...
        public:
            ...
            // 警告数量
            uint16_t warning_count() const {
                return warning_count_;
            }
            const char* warning_info() const {
                return warning_info_.c_str();
            }
            // 受影响的行数
            ...
            void Dump() {
                rowreaders_[rowreaders_index_]->Dump();
            }
